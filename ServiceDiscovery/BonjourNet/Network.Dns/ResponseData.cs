...
{
    internal abstract class ResponseData
    {
    ...
    internal class UnknownResponseData : ResponseData
    {
    ...
    internal class CName : ResponseData
    {
    ...
    internal class HostAddress : ResponseData
    {
    ...
    internal class Ptr : ResponseData
    {
    ...
    internal class Srv : ResponseData
    {
        public override void WriteTo(Stream writer)
        {
    ...
    internal class Txt : ResponseData
    {
        public Txt()
        {
